...
// $sql = "SELECT * FROM tbl_usuarios WHERE CodiNivelAcesso='4'";
...
<h2>Relatório Por Coordenação</h2>
...
<form action="index_sistema.php" method="GET">
    ...
    <div class="col-md-4 col-md-offset-3 form-group" style="display: inline-table;">
        ...
        <input type="text" name="Data_Coordenador" id="reservation" class="form-control" data-inputmask="'mask': '99/99/9999 - 99/99/9999'" value="<?php echo $data; ?>" />
    </div>
